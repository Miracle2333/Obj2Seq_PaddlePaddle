...
from .predictors.seq_postprocess import build_sequence_postprocess
from .def_transformer import DeformableTransformerDecoderLayer
...
class UnifiedSeqHead(DeformableTransformerDecoderLayer):
    ...
    def forward(self, feat, query_pos, reference_points, srcs, src_padding_masks, **kwargs):
        ...
        for id_step, output_embed in enumerate(self.output_embeds):
            ...
            output_feat = super().forward(feat, forward_reference_points, srcs,\
                memory_spatial_shapes, memory_level_start_index, memory_valid_ratios, src_padding_masks, query_pos, cs_batch)
