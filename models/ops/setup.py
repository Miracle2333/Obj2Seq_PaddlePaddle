...
>>>        ) and torch.utils.cpp_extension.CUDA_HOME is not None:
...
setup(name='MultiScaleDeformableAttention', version='1.0', author=
    'Weijie Su', url='https://github.com/fundamentalvision/Deformable-DETR',
    description=
    'PyTorch Wrapper for CUDA Functions of Multi-Scale Deformable Attention',
    packages=find_packages(exclude=('configs', 'tests')), ext_modules=
>>>    get_extensions(), cmdclass={'build_ext': torch.utils.cpp_extension.
    BuildExtension})
