...
class nnMultiheadAttention(nn.Layer):
    ...
    Examples::
        ...
        >>> multihead_attn = nnMultiheadAttention(embed_dim, num_heads)
    ...
    def __setstate__(self, state):
        ...
        super(nnMultiheadAttention, self).__setstate__(state)
...
if __name__ == "__main__":
    ...
    model = nnMultiheadAttention(256, 8, 0.0)
