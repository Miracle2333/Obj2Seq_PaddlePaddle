# Borrow from https://github.com/facebookresearch/Detic/blob/85f289b33631cd206de00d6ad9026d8565efb3c0/tools/dump_clip_features.py
...
if __name__ == '__main__':
    ...
    device = "cuda" if paddle.version.cuda() != "False" else "cpu"
